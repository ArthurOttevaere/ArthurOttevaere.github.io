...
const Icon = {
  // Brand mark — the "a." monogram. Filled with currentColor so it takes the
  // active accent (nav) or white (on the accent-coloured footer). viewBox is
  // cropped tight to the glyphs so it scales cleanly at small sizes.
  Logo: (p) => (
    <svg viewBox="62 122 232 180" fill="currentColor" {...p}>
